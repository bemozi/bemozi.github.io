...
We do not provide data recovery services. As files are stored locally, the processes of data security, retention, backup, and deletion remain the user's sole responsibility.
